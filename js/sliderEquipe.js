$(function(){
  ...
  function initSlider() {
    ...
    for(var i = 0; i < amt; i++){
      if(i == 0)
        $('.slider-bullets').append('<span style="backgorund-color:rgb(170, 170, 170);"></span>');
      else
  ...
  function goToSlider(curIndex){
    ...
    $('.scrolEquipe').stop().animate({'scrollLeft':offSetX+'px'});
  }

  $(window).resize(function(){
    $('.scrolEquipe').stop().animate({'scrollLeft':0});
  })
